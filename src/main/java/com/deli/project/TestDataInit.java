...
public class TestDataInit {
    ...
    public void dataInit(){
        Member memberA = Member.createMember("memberA","1111","memberA","010-1111-2222", BASIC,new Address("서울특별시","영등포구","123-456"));
        Member memberB = Member.createMember("memberB","2222","memberB","010-2222-2222", BASIC,new Address("서울특별시","강남구","789-456"));
        Member memberC = Member.createMember("memberC","3333","memberC","010-3333-3333", ADMIN,new Address("서울특별시","송파구","1111-5544"));
